...
pub struct SubmitJobResponse {
    #[prost(enumeration = "submit_job_response::Status", tag = "1")]
    pub status: i32,
}
...
pub mod eq_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static("/eqs.Eq/SubmitJob");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new("eqs.Eq", "SubmitJob"));
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/eqs.Eq/SubmitJob" => {
                    ...
                    struct SubmitJobSvc<T: Eq>(pub Arc<T>);
                    impl<T: Eq> tonic::server::UnaryService<super::SubmitJobRequest>
                    for SubmitJobSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Eq>::submit_job(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
